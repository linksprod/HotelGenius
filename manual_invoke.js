...
const data = JSON.stringify({
    record: {
        notification_id: '8f4e045e-729d-4a34-86af-969b8d0048cd',
        type: 'booking_confirmed',
        recipient_id: 'cb6315aa-7f1b-4285-b113-16ba6e6fac3e',
        hotel_id: '00000000-0000-0000-0000-000000000000',
        title: 'Manual Test with Fallback',
        body: 'Testing the edge function output with table_reservation fallback.',
        status: 'pending',
