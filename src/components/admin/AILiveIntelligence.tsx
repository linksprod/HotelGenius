...
const AILiveIntelligence: React.FC = () => {
  ...
  return (
    <div className="bg-card/40 dark:bg-zinc-900/40 backdrop-blur-xl border border-border dark:border-white/5 rounded-2xl overflow-hidden shadow-sm h-16 sm:h-20 flex items-center px-3 sm:px-6 gap-2 sm:gap-4">
      ...
      <div className="flex-1 min-w-0 overflow-hidden relative">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-xs sm:text-sm font-semibold text-foreground truncate min-w-0 flex-1">
              {current.message}
            </p>
