...
const filterCards: FilterCard[] = [
  { id: 'all', label: 'All Guests', countKey: 'all', icon: Users, colorClass: 'text-violet-500', bgClass: 'bg-violet-500/10', cardBgClass: 'border-violet-500/10' },
      ...
      <ScrollArea className="flex-1">
        ...
        >
          ...
          >
            <AdminPageHeader
              title="Guest 360°"
              description="Real-time guest profiles and stay preferences."
              ...
              actions={
                <>
                  <Button
                    ...
                    variant="outline"
                    className={cn(
                      "h-9 px-4 rounded-xl font-medium border-border shadow-sm transition-all text-xs",
                      activeFilter === 'all' ? "bg-primary text-primary-foreground hover:bg-primary/90" : "bg-card hover:bg-muted"
                    )}
                  >
                  ...
                  <Button
                    variant="outline"
                    className="h-9 px-4 rounded-xl font-medium border-border shadow-sm transition-all text-xs"
                  >
                    Export PDF
                  </Button>
                  <Button
