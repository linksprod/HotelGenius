...
export const FeedbackManager = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-background text-foreground overflow-hidden">
      ...
      >
        <AdminPageHeader
          title="Guest Pulse & Reputation"
          description="Aggregating sentiment across all major travel platforms."
          icon={<Heart className="h-5 w-5 text-primary" />}
          actions={
            <div className="flex items-center gap-3">
              <div className="hidden sm:flex px-2 py-0.5 rounded bg-amber-500/10 text-amber-500 border border-amber-500/20 text-[10px] font-bold uppercase tracking-widest items-center gap-1.5 mr-2">
              ...
              <Button 
                ...
                className="h-10 px-4 gap-2 bg-card dark:bg-zinc-900 border-border dark:border-white/5 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-foreground rounded-xl shadow-sm transition-all"
              >
