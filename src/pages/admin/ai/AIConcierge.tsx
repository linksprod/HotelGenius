    ...
    <div className="flex flex-col h-full bg-background text-foreground overflow-hidden">
      <ScrollArea className="flex-1">
        <div className="p-8 space-y-8">
          ...
          >
            <AdminPageHeader
              title="AI Concierge Control"
              description="Monitoring and orchestrating guest experiences in real-time."
              ...
              actions={
                <div className="flex items-center gap-3">
                  ...
                  <Button variant="outline" className="bg-zinc-100 dark:bg-zinc-900 border-zinc-200 dark:border-white/5 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-xs font-bold h-10 px-4 rounded-xl">
                    <History className="mr-2 h-4 w-4" /> View Full Logs
                  </Button>
                  <Button 
                    onClick={() => { setSettingsTab('general'); setIsSettingsOpen(true); }}
                    className="bg-primary text-primary-foreground hover:bg-primary/90 text-xs font-black h-10 px-4 rounded-xl shadow-xl shadow-primary/10"
                  >
