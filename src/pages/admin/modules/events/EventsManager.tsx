        ...
        >
          ...
          >
            <AdminPageHeader
              ...
              description="Curate events, manage bookings, and publish stories."
              icon={<PartyPopper className="h-5 w-5 text-primary" />}
              actions={
                <div className="flex items-center gap-3">
                  <div className="px-3 py-1.5 rounded-lg bg-purple-500/10 text-purple-500 border border-purple-500/20 text-xs font-bold uppercase tracking-widest flex items-center gap-1.5">
                    <Sparkles className="h-3.5 w-3.5" />
                    Experience Management
                  </div>
                  <div className="h-10 px-4 rounded-xl bg-card dark:bg-zinc-900/40 border border-border dark:border-white/5 backdrop-blur-md flex items-center gap-3">
