...
const NearbyShopsTab = () => {
  ...
  // Filter only nearby places (non-hotel shops)
    ...
    <>
      <Card className="p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-medium">Nearby Places</h2>
                         ...
                         <AlertDialogContent>
                           <AlertDialogHeader>
                             ...
                             <AlertDialogDescription>
                               This action is irreversible. The nearby place "{shop.name}" will be permanently deleted.
                             </AlertDialogDescription>
                           </AlertDialogHeader>
                           <AlertDialogFooter>
