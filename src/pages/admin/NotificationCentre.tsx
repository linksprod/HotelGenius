        ...
        <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-rose-500/10 border border-rose-500/20 w-fit">
              ...
              <span className="text-[10px] font-bold text-rose-500 uppercase tracking-[0.2em]">Intelligence Hub</span>
            </div>
            
            <h1 className="text-5xl font-black tracking-tight text-foreground leading-[1.1]">
              Notification <span className="text-muted-foreground/30">Centre</span>
            </h1>
            <p className="text-muted-foreground font-medium text-lg max-w-2xl">
              Real-time synchronization of AI insights, guest movements, and high-impact operational alerts.
            </p>
          </div>

          <div className="flex items-center gap-3">
            <Button variant="outline" className="h-12 px-6 gap-2 bg-card dark:bg-zinc-900 border-border dark:border-white/5 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-foreground rounded-xl shadow-sm">
              <Filter className="h-4 w-4" />
              Filter
            </Button>
            <Button className="h-12 px-6 gap-2 bg-rose-500 hover:bg-rose-600 text-white rounded-xl shadow-lg shadow-rose-500/20 font-bold">
