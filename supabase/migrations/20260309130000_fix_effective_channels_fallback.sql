-- Migration to fix get_effective_channels fallback for users without preferences
-- Date: 2026-03-09
...
BEGIN
    ...
    -- FIX: If no preferences found, return the default allowed channels for this type
    -- (This allows guest bookings to receive emails even without explicit preferences)
    IF NOT FOUND THEN
    ...
    -- Fallback: if no external channels survived but type allows them, 
    -- and we have in_app, return what survived.
    -- If nothing survived at all, fallback to in_app.
